// SDFGen - A simple grid-based signed distance field (level set) generator for
// triangle meshes. Written by Christopher Batty (christopherbatty@yahoo.com,
// www.cs.columbia.edu/~batty)
//...primarily using code from Robert Bridson's website
...
int main(int argc, char* argv[]) {
  if (argc != 4) {
    ...
    std::cout << "(ni,nj,nk) are the integer dimensions of the resulting "
                 "distance field.\n";
    std::cout << "(origin_x,origin_y,origin_z) is the 3D position of the grid "
                 "origin.\n";
    ...
    std::cout << "\t<dx> specifies the length of grid cell in the resulting "
                 "distance field.\n";
    std::cout << "\t<padding> specifies the number of cells worth of padding "
                 "between the object bound box and the boundary of the "
                 "distance field grid. Minimum is 1.\n\n";
